#!/bin/bash
# ==============================================================================
# SUBMIT PHASE 11B ENGINE V3 RESEARCH PIPELINE TO UMASS AMHERST UNITY HPC
# ==============================================================================
set -euo pipefail
...
echo "======================================================================"
echo "SUBMITTING PHASE 11B ENGINE V3 ALPHA REDESIGN RESEARCH TO UNITY HPC"
echo "Target Cluster : UMass Amherst Unity HPC"
echo "Partition      : uri-cpu (32 CPUs, 96GB RAM)"
echo "Mode           : ENGINE V3 CANDIDATE WALK-FORWARD RESEARCH"
echo "======================================================================"
...
SUBMIT_OUTPUT=$(ssh ${REMOTE_HOST} "cd ${REMOTE_DIR} && sbatch jobs/phase11b_engine_v3.slurm")
echo "${SUBMIT_OUTPUT}"
...
echo "  ./scripts/unity/check_phase11b_job.sh ${JOB_ID}"
echo ""
echo "To tail the remote log in real-time:"
echo "  ssh unity \"tail -f ${REMOTE_DIR}/logs/slurm_phase11b_${JOB_ID}.log\""
echo ""
echo "After job completion, pull results back to your Mac:"
echo "  ./scripts/unity/pull_phase11b_results.sh"
echo "======================================================================"
