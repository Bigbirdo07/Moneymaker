...
| **Tier 2 Ramp** | **$5,000.00 USD** | `SIMULATED_PROJECTED` | **NOT YET VALIDATED** | Phase 6C (`TIER2_READY_FOR_AUTHORIZED_EVALUATION`)|
...
| **Phase 6C** | `ALPHA_A_INTRADAY_RELATIVE_MOMENTUM_V1` | $5,000.00 | `LIVE_AUTONOMOUS_MICRO` | 0 | 0 | `SIMULATED_PROJECTED`| `TIER2_READY_FOR_AUTHORIZED_EVALUATION` | `HEAD` | 130 | **PENDING_AUTH**|
